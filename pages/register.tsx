...
import { RegistrationResponse } from "types/api/RegistrationResponse";
import { setAccessToken, setCurrentUser } from "state/slices/userSlice";
...
const RegisterPage = () => {
  ...
  const onSubmit = handleSubmit(
    async ({ email, password, confirmpassword }) => {
      try {
        const results = await unauthenticatedAxios.post<RegistrationResponse>(
          "/api/registration/",
          {
            email,
            password1: password,
